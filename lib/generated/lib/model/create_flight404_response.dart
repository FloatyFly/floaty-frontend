...
class CreateFlight404Response {
  /// Returns a new [CreateFlight404Response] instance.
  CreateFlight404Response({
    this.error,
  });
  ...
  /// Returns a new [CreateFlight404Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CreateFlight404Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return CreateFlight404Response(
  ...
  static List<CreateFlight404Response> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CreateFlight404Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CreateFlight404Response> mapFromJson(dynamic json) {
    final map = <String, CreateFlight404Response>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CreateFlight404Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
