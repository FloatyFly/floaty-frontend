...
class GetGliderById404Response {
  /// Returns a new [GetGliderById404Response] instance.
  GetGliderById404Response({
    this.error,
  });
  ...
  /// Returns a new [GetGliderById404Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GetGliderById404Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return GetGliderById404Response(
  ...
  static List<GetGliderById404Response> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = GetGliderById404Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, GetGliderById404Response> mapFromJson(dynamic json) {
    final map = <String, GetGliderById404Response>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GetGliderById404Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
